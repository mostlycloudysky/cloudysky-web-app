          ...
          <div className='pl-5 pt-5 flex'>
            ...
            <div className='pt-5 pl-8'>
                ...
                <div className=' flex items-center space-x-3'>
                  <Link href='https://www.linkedin.com/in/sandeep-yaramchitti-74833475/'  passHref={true} >
                  ...
                  <Link href='https://github.com/SandeepKumarYaramchitti'  passHref={true} >
                    <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
                      <svg className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="w-5" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                  ...
                  <Link href='https://twitter.com/sandeep01957280'  passHref={true} >
                  ...
                  <Link href='https://mail.google.com/mail/u/0/#inbox'  passHref={true} >
